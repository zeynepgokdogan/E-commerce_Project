                    ...
                    <div class="div-center">
                        <div class="form-container">
                            ...
                            <form action="{{ route('update_product', $product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST') <!-- Use this if you are using POST for updates, change to 'PUT' if required -->
                                ...
                                <input type="text" id="discount" name="discount" value="{{ old('discount', $product->discount_price) }}">
